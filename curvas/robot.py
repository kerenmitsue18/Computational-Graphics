...
M = np.array([[11,-0.25,1],[12,-0.25,1],
              [12,0,1],[11.5,0,1],
              [11.5,0.25,1],[12,0.25,1],
              [12,0.5,1],[11,0.5,1],
              [ 11,-0.25,1]])
#Figura de robot 
fig = plt.figure()
...
T2 = np.array([
       ...
       [-1.49697581e-01,  2.27379459e-01,1],
       [ 3.13155242e+00,  2.46380476e+00,1],
       [ 3.27520161e+00,  2.24935302e+00,1],
       [-6.04838710e-03, -2.39026396e-03,1]])
...
P = np.array(plt.ginput(5,mouse_stop=5))
