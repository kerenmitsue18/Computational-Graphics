...
Descripción: Seleccionar tres puntos en el pano 2D y calcular 4 puntos 
...
for i in range(0,t.size):
    ...
    T[i,0] = ((1-t[i])**2) *(P[0,0]) + (1-t[i])*t[i]*P[1,0] + (t[i]**2)*P[2,0]
    T[i,1] = ((1-t[i])**2) *(P[0,1]) + (1-t[i])*t[i]*P[1,1] + (t[i]**2)*P[2,1]
